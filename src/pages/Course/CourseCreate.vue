        ...
        <el-step title="完成"></el-step>
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane :disabled="true" label="" name="first" style="height: 420px">
                    <div class="name">
                        <div class="name_title">课程名称</div>
                        <el-input class="name_input" v-model="courseName" placeholder="请输入内容（必填）"></el-input>
                    </div>
          ...
          <div class="file">
            <div class="file_title">文件上传
              <span>上传100KB以上文件容易失败，请多次尝试或压缩</span>
            </div>
              ...
              <span class="second_description">输入关键字，点击即可添加 </span>
                ...
                <!-- <el-table :data="myStaff" max-height="500" style="width: 100%" :border="false" stripe>
                        ...
                        <div class="next">
                            ...
                            <el-button type="primary" @click="AddNewCourse()">日后再说</el-button>
                        </div>
                    </div>
                </el-tab-pane> -->
...
export default {
    ...
    methods: {
        ...
        //         ? candidate.filter(this.createFilter(queryString))
        //         : candidate;
        ...
        //             !this.findItem(candidate.userId)
        //         );
        //     };
        // },
        // handleSelect(item) {
