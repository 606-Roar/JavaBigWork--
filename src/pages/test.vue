<template>
    <div class="index" v-loading.fullscreen.lock="fullscreenLoading" element-loading-text="拼命加载中...">
        ...
        <el-table :data="excelData" tooltip-effect="dark">
            <el-table-column label="名称" prop="studentName" show-overflow-tooltip></el-table-column>
            <el-table-column label="分量" prop="studentId" show-overflow-tooltip></el-table-column>
            <el-table-column label="口味" prop="sex" show-overflow-tooltip></el-table-column>
            <el-table-column label="单价(元)" prop="class" show-overflow-tooltip></el-table-column>
        </el-table>
    </div>
</template>
